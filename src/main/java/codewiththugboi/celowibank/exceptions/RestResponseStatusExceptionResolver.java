...
public class RestResponseStatusExceptionResolver extends AbstractHandlerExceptionResolver {
    ...
    private ModelAndView handleIllegalArgument(final HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
    ...
    /**
     * Prepares error object based on the provided except type.
     *
     * @param accept To Accept header present in the request.
     * @return The login to return
     */
